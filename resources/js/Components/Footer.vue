        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
                ...
                <div class="space-y-3 sm:space-y-4 text-center sm:text-left">
                    ...
                    <!-- Company Description -->
                    <p
                        class="text-gray-700 text-sm leading-relaxed px-4 sm:px-0"
                    >
                    ...
                    <!-- Social Media Icons -->
                    <div
                        class="flex justify-center sm:justify-start space-x-2 sm:space-x-3"
                    >
                        <!-- Instagram -->
                        <a
                ...
                <div
                    class="grid grid-cols-2 gap-6 sm:gap-8 text-center sm:text-left"
                >
                    <!-- Navigation Links -->
            ...
            <!-- Bottom Copyright -->
            <div
                class="mt-8 sm:mt-10 md:mt-12 pt-6 sm:pt-8 border-t border-gray-300"
            >
                <p
