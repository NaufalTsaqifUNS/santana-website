...
const searchRentalCars = () => {
    router.get(
        route("rentals.index"),
        {
            ...
            category:
                activeCategory.value !== "All" ? activeCategory.value : null,
        },
        {
            preserveState: true,
            preserveScroll: true,
        ...
        <section class="relative h-screen w-full overflow-hidden">
            ...
            <div class="relative z-10 h-full flex items-center">
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="max-w-3xl">
                        <h1
                            class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-4 drop-shadow-lg"
                        >
                            Rent Your
                        ...
                        <p
                            class="text-lg sm:text-xl md:text-2xl text-white mb-8 drop-shadow-md"
                        >
        ...
        <section id="cars" class="bg-gray-50 py-12 sm:py-16 md:py-20">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                ...
                <div class="text-center space-y-4">
                    ...
                    <p
                        class="text-gray-600 text-base sm:text-lg max-w-2xl mx-auto"
                    >
