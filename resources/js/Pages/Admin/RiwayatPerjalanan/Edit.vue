                ...
                >
                    <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
                        <h2 class="text-lg font-semibold text-gray-900">
                            Formulir Edit Perjalanan
                        </h2>
                        <p class="text-sm text-gray-500 mt-1">
                            Update data perjalanan yang sudah ada
                        </p>
                    </div>
                    ...
                    <form @submit.prevent="submit" class="p-6">
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div>
                                    <p
                                        class="text-xs text-gray-600 mb-2 font-medium"
                                    >
                                        Ganti Foto (Opsional):
                                    </p>
                                    <div
...
const submit = () => {
    ...
    router.post(
        route("riwayat-perjalanan.update", props.riwayat.id),
        formData,
        {
            onSuccess: () => {
